...
}`}),Ke={};for(let e of Object.values(Ge))try{let t=JSON.parse(e);t&&t.name&&Array.isArray(t.stepList)&&(Ke[t.name]=t)}catch{continue}var qe=e=>Ke[e],Je=()=>Object.values(Ke),Ye=e=>Ke[e.next],Xe=e=>Je().find(t=>t.faction===e.faction&&t.race===e.race),Ze=(e,t)=>{let n=Je().filter(t=>t.next===e.name);return n.find(e=>e.race===t.race&&e.class===t.class)??n.find(e=>e.race===t.race&&!e.class)??n.find(e=>e.class===t.class&&!e.race)??n.find(e=>!e.race&&!e.class)},Qe=5,$e=(e,t)=>!e.onlyFor||e.onlyFor.length===0?!0:e.onlyFor.some(e=>(!e.race||e.race===t.race)&&(!e.class||e.class===t.class)),et=(e,t)=>{let n=[];return e.stepList.forEach(e=>{$e(e,t)&&n.push({step:e,filteredIndex:n.length})}),n},tt=(e,t)=>`${e},${t}`,nt=e=>{let t=[],n=[],r=(e,t,n)=>{let r=n.step.coordinates;e.groups.push({marker:e.groups.length+1,x:r.x,y:r.y,areaID:r.areaID,steps:[n]}),t.add(tt(r.x,r.y))},i=e=>{let i={zoneID:e.step.coordinates.zoneID,groups:[]},a=new Set;t.push(i),n.push(a),r(i,a,e)};for(let a of e){let e=a.step.coordinates,o=t[t.length-1];if(!o){i(a);continue}let s=n[n.length-1],c=o.groups[o.groups.length-1];e.zoneID===o.zoneID&&e.x===c.x&&e.y===c.y?c.steps.push(a):e.zoneID!==o.zoneID||s.has(tt(e.x,e.y))||o.groups.length>=Qe?i(a):r(o,s,a)}return t},rt=e=>{let t=Xe(e),n=[],r=new Set;for(;t&&!r.has(t.name);)n.push(t),r.add(t.name),t=Ye(t);return n},it=e=>{let t=[],n=1;for(let r of rt(e))nt(et(r,e)).forEach((e,i)=>{t.push({guide:r.name,section:i,level:n});for(let t of e.groups)for(let{step:e}of t.steps)if(e.type===`Level Up`&&e.description){let t=Number(e.description);Number.isFinite(t)&&(n=Math.max(n,t))}});return{stops:t,maxLevel:Math.max(1,n,...t.map(e=>e.level))}},at=(e,t)=>{let n;for(let r of e.stops)r.level<=t&&(!n||r.level>n.level)&&(n=r);return n??e.stops[0]},ot=(e,t)=>{let n=new Set;for(let r=0;r<t&&r<e.length;r++)for(let t of e[r].groups)for(let{step:e}of t.steps)e.questID!=null&&(e.type===`Accept Quest`?n.add(e.questID):e.type===`Turn in Quest`&&n.delete(e.questID));return[...n]},st=(e,t,n,r)=>{let i=n.startHearthstone??le(r.race,r.class);for(let n=0;n<t&&n<e.length;n++)for(let t of e[n].groups)for(let{step:e}of t.steps)e.setHearthstone!=null&&(i=e.setHearthstone);return i},ct=`rounded-xl border border-slate-700 bg-slate-800/40 p-4`,lt=({character:e,onExit:t,onNavigate:n})=>{let r=(0,l.useRef)(null),i=(0,l.useRef)(null),[a,o]=(0,l.useState)({headerH:56,mapH:0,blockH:0,isDesktop:!1});(0,l.useEffect)(()=>{let e=()=>{let e=document.querySelector(`header`);o({headerH:e?Math.round(e.getBoundingClientRect().height):56,mapH:r.current?.offsetHeight??0,blockH:i.current?.offsetHeight??0,isDesktop:window.matchMedia(`(min-width: 1024px)`).matches})};e();let t=new ResizeObserver(e);return r.current&&t.observe(r.current),i.current&&t.observe(i.current),window.addEventListener(`resize`,e),()=>{t.disconnect(),window.removeEventListener(`resize`,e)}},[]);let s=a.isDesktop?80:a.headerH+24,c=a.isDesktop?80:a.headerH+24+a.mapH+12,u=a.isDesktop?void 0:c+a.blockH,d=qe(e.guide),p=(0,l.useMemo)(()=>d?nt(et(d,e)):[],[d,e]),m=p[e.section],g=m?.groups.map(e=>({number:e.marker,x:e.x,y:e.y}))??[],[_,y]=(0,l.useState)(null),b=(0,l.useRef)({}),x=e=>{b.current[e]?.scrollIntoView({behavior:`smooth`,block:`start`})},S=c+a.blockH+12;ze(`${e.guide}:${e.section}`);let C=(0,l.useMemo)(()=>ot(p,e.section),[p,e.section]),ne=(0,l.useMemo)(()=>d?st(p,e.section,d,e):0,[d,p,e]),re=(0,l.useMemo)(()=>it(e),[e]),w=(e,t)=>re.stops.find(n=>n.guide===e&&n.section===t)?.level??1,ie=e=>re.stops.filter(t=>t.guide===e).length,ae=d?Ye(d):void 0,oe=d?Ze(d,e):void 0,ce=e.section<=0,le=e.section>=p.length-1,ue=!ce||!!oe,T=!le||!!ae,E=(e,t)=>{n(e,t,w(e,t))};return(0,f.jsxs)(`div`,{className:`flex w-full max-w-6xl flex-col gap-3 lg:flex-row lg:items-start`,children:[(0,f.jsx)(`div`,{ref:r,style:{top:s},className:h(ct,`sticky z-30 flex flex-col gap-2 lg:w-2/3 lg:shrink-0`),children:m?(0,f.jsxs)(f.Fragment,{children:[(0,f.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,f.jsx)(`span`,{className:`shrink-0 text-sm font-bold text-slate-100`,children:De(m.zoneID)}),(0,f.jsx)(We,{level:e.level,maxLevel:re.maxLevel,onSeek:e=>{let t=at(re,e);t&&n(t.guide,t.section,t.level)},className:`flex-1`})]}),(0,f.jsxs)(`div`,{className:`relative`,children:[(0,f.jsx)(ge,{src:ke(m.zoneID)??``,alt:De(m.zoneID),markers:g,activeMarker:_,onMarkerHover:y,onMarkerClick:x}),(0,f.jsx)(`button`,{type:`button`,onClick:()=>{ce?oe&&E(oe.name,ie(oe.name)-1):E(e.guide,e.section-1)},disabled:!ue,"aria-label":`Previous section`,className:`group absolute inset-y-0 left-0 z-10 flex w-14 items-center justify-start bg-linear-to-r from-slate-900/75 to-transparent text-yellow-400 transition-opacity disabled:pointer-events-none disabled:opacity-0 cursor-pointer`,children:(0,f.jsx)(v,{src:`/icons/ui/IconChevronRight.svg`,className:`ml-1 h-8 w-8 rotate-180 transition-transform group-hover:scale-125`})}),(0,f.jsx)(`button`,{type:`button`,onClick:()=>{le?ae&&E(ae.name,0):E(e.guide,e.section+1)},disabled:!T,"aria-label":`Next section`,className:`group absolute inset-y-0 right-0 z-10 flex w-14 items-center justify-end bg-linear-to-l from-slate-900/75 to-transparent text-yellow-400 transition-opacity disabled:pointer-events-none disabled:opacity-0 cursor-pointer`,children:(0,f.jsx)(v,{src:`/icons/ui/IconChevronRight.svg`,className:`mr-1 h-8 w-8 transition-transform group-hover:scale-125`})})]})]}):(0,f.jsx)(`p`,{className:`text-center text-sm text-slate-500`,children:d?`No section to show.`:`Guide not found: ${e.guide}`})}),(0,f.jsxs)(`div`,{className:`relative flex min-w-0 flex-1 flex-col gap-3`,children:[(0,f.jsx)(`div`,{"aria-hidden":!0,style:{top:0,height:u},className:`pointer-events-none fixed left-0 z-20 w-full bg-linear-to-b from-slate-900 from-75% to-transparent lg:h-38`}),(0,f.jsxs)(`div`,{ref:i,style:{top:c},className:`sticky z-30 flex flex-col gap-2.5 rounded-xl border border-slate-700 bg-slate-800/60 p-3 backdrop-blur`,children:[(0,f.jsxs)(`div`,{className:`flex items-center justify-between gap-3`,children:[(0,f.jsxs)(`div`,{className:`flex min-w-0 items-center gap-2.5`,children:[(0,f.jsx)(`span`,{className:`h-9 w-9 shrink-0 overflow-hidden rounded-md ring-1 ring-inset ring-black/40`,style:{boxShadow:`inset 0 0 0 2px ${ee[e.class]}`},children:(0,f.jsx)(`img`,{src:te(e.race,e.gender),alt:`${e.race} ${e.gender}`,className:`h-full w-full object-cover`})}),(0,f.jsxs)(`div`,{className:`flex min-w-0 flex-col`,children:[(0,f.jsx)(`span`,{className:`truncate text-sm font-bold text-slate-100`,children:e.name}),(0,f.jsxs)(`span`,{className:`truncate text-xs text-slate-400`,children:[e.race,` `,e.class,` · Level `,e.level]})]})]}),(0,f.jsx)(`button`,{type:`button`,onClick:t,"aria-label":`Change character`,title:`Change character`,className:`flex shrink-0 cursor-pointer items-center justify-center self-center rounded p-1.5 text-slate-400 transition-colors hover:text-slate-200`,children:(0,f.jsx)(v,{src:`/icons/ui/IconOptions.svg`,className:`h-5 w-5`})})]}),m&&(0,f.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2`,children:[(0,f.jsxs)(`a`,{href:ye(`zone`,ne),"data-db":`zone=${ne}`,target:`_blank`,rel:`noopener noreferrer`,title:`Current Hearthstone`,className:`flex items-center gap-1.5 rounded-md border border-slate-600 px-2 py-1 text-xs font-semibold text-purple-300 hover:border-slate-500`,children:[(0,f.jsx)(`img`,{src:`/icons/steps/IconHearthstone.png`,alt:`Hearthstone`,className:`h-4 w-4 object-contain`}),Oe(ne)]}),(0,f.jsx)(Be,{questLog:C})]})]}),m&&(0,f.jsx)(`div`,{className:h(ct,`flex flex-col gap-4`),children:m.groups.map(e=>(0,f.jsxs)(`div`,{ref:t=>{b.current[e.marker]=t},style:{scrollMarginTop:S},onMouseEnter:()=>y(e.marker),onMouseLeave:()=>y(null),children:[(0,f.jsxs)(`div`,{className:`mb-1.5 flex items-center gap-2`,children:[(0,f.jsx)(`span`,{className:h(`flex h-5 w-5 items-center justify-center rounded-full text-[0.65rem] leading-none font-bold transition-transform duration-150`,_===e.marker&&`scale-125`),style:se,children:e.marker}),(0,f.jsx)(`span`,{className:`text-xs font-semibold text-slate-400`,children:e.areaID?Oe(e.areaID):De(m.zoneID)})]}),(0,f.jsx)(`ul`,{className:`flex flex-col gap-1.5`,children:e.steps.map(e=>(0,f.jsx)(je,{step:e.step},e.filteredIndex))})]},e.marker))})]})]})},ut=()=>(0,f.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-4 w-4`,fill:`currentColor`,"aria-hidden":`true`,children:(0,f.jsx)(`path`,{d:`M12 .5C5.37.5 0 5.78 0 12.29c0 5.2 3.44 9.6 8.21 11.16.6.1.82-.25.82-.56 0-.28-.01-1.02-.02-2-3.34.7-4.04-1.58-4.04-1.58-.55-1.36-1.34-1.72-1.34-1.72-1.09-.72.08-.71.08-.71 1.2.08 1.83 1.2 1.83 1.2 1.07 1.77 2.81 1.26 3.5.96.11-.76.42-1.26.76-1.55-2.67-.29-5.47-1.29-5.47-5.75 0-1.27.47-2.31 1.24-3.12-.12-.29-.54-1.46.12-3.05 0 0 1.01-.31 3.3 1.19a11.7 11.7 0 0 1 3-.39c1.02 0 2.05.13 3 .39 2.28-1.5 3.29-1.19 3.29-1.19.66 1.59.24 2.76.12 3.05.77.81 1.24 1.85 1.24 3.12 0 4.47-2.81 5.45-5.49 5.74.43.36.81 1.08.81 2.18 0 1.58-.01 2.85-.01 3.24 0 .31.21.68.83.56A12.02 12.02 0 0 0 24 12.29C24 5.78 18.63.5 12 .5z`})}),dt=()=>(0,f.jsx)(`footer`,{className:`mt-auto border-t border-slate-700 bg-slate-900/60`,children:(0,f.jsxs)(`div`,{className:`mx-auto flex max-w-6xl flex-col items-center gap-3 px-4 py-6 text-center`,children:[(0,f.jsxs)(`div`,{className:`flex flex-col items-center gap-2 text-sm text-slate-400 sm:flex-row sm:gap-4`,children:[(0,f.jsxs)(`span`,{children:[`© `,new Date().getFullYear(),` WotLK Guide`]}),(0,f.jsxs)(`a`,{href:`https://github.com/ltanailov/WotLK-Guide`,target:`_blank`,rel:`noreferrer`,className:`inline-flex items-center gap-1.5 transition-colors hover:text-slate-100`,children:[(0,f.jsx)(ut,{}),`GitHub`]})]}),(0,f.jsx)(`p`,{className:`max-w-2xl text-xs leading-relaxed text-slate-500`,children:`This is a fan-made, non-commercial project and is not affiliated with or endorsed by Blizzard Entertainment.\\nWorld of Warcraft and Wrath of the Lich King are trademarks of Blizzard Entertainment, Inc. All rights reserved by Blizzard Entertainment.`})]})}),ft=(e,t)=>{let[n,r]=(0,l.useState)(()=>{try{let n=localStorage.getItem(e);return n===null?t:JSON.parse(n)}catch{return t}});return(0,l.useEffect)(()=>{try{localStorage.setItem(e,JSON.stringify(n))}catch(t){console.error(`Failed to save '${e}' to localStorage`,t)}},[e,n]),[n,r]},pt=(0,l.createContext)(null),mt=({children:e})=>{let[t,n]=ft(`activeCharacterId`,null),[r,i]=(0,l.useState)(t?`Guide`:`CharacterSelect`);return(0,f.jsx)(pt.Provider,{value:{appMode:r,setAppMode:i,activeCharacterId:t,setActiveCharacterId:n},children:e})};function ht(){let e=(0,l.useContext)(pt);if(!e)throw Error(`useAppState must be used inside AppStateProvider`);return e}var k=()=>{let[e,t]=ft(`characters`,[]);return{characters:e,addCharacter:(0,l.useCallback)(e=>{let n={...e,id:crypto.randomUUID(),level:1,guide:ae[e.race],section:0};return t(e=>[n,...e]),n},[t]),removeCharacter:(0,l.useCallback)(e=>{t(t=>t.filter(t=>t.id!==e))},[t]),updateCharacter:(0,l.useCallback)((e,n)=>{t(t=>t.map(t=>t.id===e?{...t,...n}:t))},[t])}};(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(mt,{children:(0,f.jsx)(()=>{let{appMode:e,setAppMode:t,activeCharacterId:n,setActiveCharacterId:r}=ht(),{characters:i,addCharacter:a,removeCharacter:o,updateCharacter:s}=k(),c=i.find(e=>e.id===n)??null;return(0,f.jsxs)(`div`,{className:`flex min-h-dvh flex-col bg-slate-900 text-slate-100`,children:[(0,f.jsx)(p,{}),(0,f.jsx)(`main`,{className:`flex w-full justify-center px-4 py-6`,children:e===`Guide`&&c?(0,f.jsx)(lt,{character:c,onExit:()=>t(`CharacterSelect`),onNavigate:(e,t,n)=>{c&&s(c.id,{guide:e,section:t,level:n})}}):(0,f.jsx)(he,{characters:i,addCharacter:a,removeCharacter:e=>{o(e),e===n&&r(null)},onPlay:e=>{r(e.id),t(`Guide`)},initialSelectedId:n})}),(0,f.jsx)(dt,{})]})},{})})}));